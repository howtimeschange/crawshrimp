...
contextBridge.exposeInMainWorld('cs', {
  ...
  listTaskSchedules: (query) => ipcRenderer.invoke('list-task-schedules', query),
  createTaskSchedule: (payload) => ipcRenderer.invoke('create-task-schedule', payload),
  getTaskSchedule: (uid) => ipcRenderer.invoke('get-task-schedule', uid),
  updateTaskSchedule: (uid, payload) => ipcRenderer.invoke('update-task-schedule', uid, payload),
  deleteTaskSchedule: (uid) => ipcRenderer.invoke('delete-task-schedule', uid),
  runTaskScheduleNow: (uid) => ipcRenderer.invoke('run-task-schedule-now', uid),
