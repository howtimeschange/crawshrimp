...
def build_workbook(output: Path) -> None:
    ...
    task_headers = ["商品ID", "商家编码", "素材图片", "素材张数", "添加标题", "内容描述", "裁剪比例", "备注"]
    ...
    ws_task.append([
        ...
        "3:4",
        "示例：素材图片可留空，在 UI 选择业务图包根目录后，按商家编码自动读取 图片/主图/达人 下的前 3 张",
    ])
    ws_task.append([
        "776047586897",
        "564231A5355Z",
    ...
    for idx, width in enumerate([18, 18, 72, 12, 24, 80, 12, 48, 88], 1):
    ...
    guide_rows = [
        ...
        ("素材张数", "否", "素材图片为空且填写了“素材根目录”时生效；业务图包按顺序取 图片/主图/达人 下前 N 张；搜推图文至少 3 张、最多 9 张", "3"),
        ...
        ("素材包摆放", "建议", "推荐业务图包：素材根目录/MOP655137Z4106Z+656939D1213Y/图片/主图/达人/图片；顶层目录可用 + 关联多个商家编码；脚本只取主图图片，忽略视频和买家秀", "/Users/you/Desktop/搜推素材/MOP655137Z4106Z+656939D1213Y/图片/主图/AHOYECHO/xxx.jpg"),
