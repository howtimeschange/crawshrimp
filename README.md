...
- `v1.4.32`：深绘上新图包整理支持 `款号+AI已回...` 模拍文件夹识别，修复部分款号只下静物图、漏下正常模特图的问题。
