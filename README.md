...
## 本次更新（2026-06-08 / v1.4.21）

- 桌面端版本升级到 `v1.4.21`，正式发布会输出 `crawshrimp-v1.4.21-*` 命名的桌面安装包。
- 新增抖店运营助手混合出资活动监控与订单回放能力，支持活动范围配置、报名状态跟踪和进度汇总。
- 任务页增强长任务进度展示，支持脚本回传结构化阶段、计数、当前对象和摘要信息。
- 新增 Macy's 美国儿童鞋类目调研脚本，纳入跨境调研适配包。
- 深绘上新图包整理增强鞋包装标签图片分类，减少鞋款上传包后续人工整理。

## 上次更新（2026-06-03 / v1.4.20）
...
- `v1.4.21`：新增抖店混合出资活动监控 / 订单回放，强化长任务进度展示，并补充 Macy's 儿童鞋调研和深绘鞋包装标签分类。
