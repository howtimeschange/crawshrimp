...
## 上上次更新（2026-05-28 / v1.4.17）

- 桌面端版本升级到 `v1.4.17`，正式发布会输出 `crawshrimp-v1.4.17-*` 命名的桌面安装包。
...
- `v1.4.17`：修复深绘上新图包下载尾段 99.6% 停滞；导出和图包压缩改为后台线程，保持状态/日志可轮询。
