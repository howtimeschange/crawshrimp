...
## v2.5.3 AI 视频结果恢复、输入错误提示与深绘 OCR 隔离（2026-09-04）

`v2.5.3` 是 `v2.5.2` 之后的补丁发布，集中同步本地领先的 AI 视频工作流结果恢复与素材复核、AI 生图输入准备错误提示，以及深绘服饰/鞋品 OCR 隔离改进。运营可以更稳定地继续查看和下载已完成的视频结果，重跑时避免召回已清理素材，并在输入文件不可读时直接看到可处理的失败原因。
