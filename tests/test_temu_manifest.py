...
class TemuManifestTests(unittest.TestCase):
    ...
    def test_wash_label_create_and_download_is_guarded_full_chain(self):
        ...
        self.assertEqual(params["scm_composition_mode"]["default"], "safe_simple")
        ...
        self.assertEqual(params["care_symbols_json"]["visible_when"], {"field": "care_symbols_mode", "not_equals": "pilot_defaults"})
