...
class ShenhuiShoePackagingRuleTests(unittest.TestCase):
    ...
    def test_wpz5_targeted_pool_geometry_rejects_horizontal_white_and_yk_candidates(self):
        with tempfile.TemporaryDirectory() as tmpdir:
            root = Path(tmpdir)
