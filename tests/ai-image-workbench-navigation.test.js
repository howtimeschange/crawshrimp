...
test('AI image workbench keeps task records as a persistent right-side menu', () => {
  ...
  const resultsStart = workbench.indexOf('v-if="workspaceMode === \'results\'" class="aiw-result-wall"', workspaceBodyStart)
  const detailStart = workbench.indexOf('v-else-if="workspaceMode === \'tasks\'" class="aiw-task-detail-panel"', workspaceBodyStart)
  const sidebarStart = workbench.indexOf('class="aiw-history-sidebar"', workspaceBodyStart)
  ...
  assert.match(workbench, /class="aiw-workspace-body"/)
  assert.match(workbench, /v-if="workspaceMode === 'results'" class="aiw-result-wall"/)
  assert.match(workbench, /v-else-if="workspaceMode === 'tasks'" class="aiw-task-detail-panel"/)
  assert.match(workbench, /class="aiw-history-sidebar"/)
  ...
  assert.ok(detailStart > 0 && detailStart < sidebarStart, 'task detail should share the same body before the persistent task menu')
